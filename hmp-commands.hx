...
ETEXI

    {
        ...
        .params     = "filename",
        .help       = "load TLC protocol configuration information from a file",
        .user_print = monitor_user_noop,
        .mhandler.cmd_new = do_config_tlc,
    },

STEXI
@item config_tlc
@findex config_tlc
Load TLC protocol configuration information from tlc_params.conf.
ETEXI
