...
#define SEND_BLOCK_REQ_CMD     "PUT "
#define SEND_BLOCK_REQ_CMD_LEN 4 
...
void create_restoration_script(uint64_t tp){
  ...
  fprintf(fp, "echo \"/home/kasidit/TLCVM/restore-block ${1} ${2} %" PRId64 " %" PRId64 " ${3} > ${4} \" | at now \n", total_pages, base_page_id); 
  printf("Create script containing: ./restore-block ${1} ${2} %" PRId64 " %" PRId64 " ${3} > ${4} \n", total_pages, base_page_id); 
  fclose(fp);
